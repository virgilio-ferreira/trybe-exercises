...
const toObject = ([name, brand, year]) => ({name, brand, year}); // detalhe que no primeiro tem que ser [] pq entra um array e envolta das chaves precisa ter um parênteses, não sei bem porque.
